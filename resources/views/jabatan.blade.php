        ...
        <div class="container-fluid py-1 px-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                    ...
                    <li class="breadcrumb-item text-sm"><a class="opacity-5 text-white" href="javascript:;">Data Gaji</a></li>
                    <li class="breadcrumb-item text-sm"><a class="opacity-5 text-white" href="javascript:;">Presensi Pegawai</a></li>
                </ol>
                        ...
                        <table class="table table-striped">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td class="align-middle">Kepala Sekolah</td>
                                ...
                                <tr>
                                    ...
                                    <td class="align-middle">Wakil Kepala Sekolah</td>
                                    <td class="align-middle">
                                        <div class="d-flex justify-content-end">
                                            <button class="btn btn-sm btn-primary">Edit</button>
                                            <button class="btn btn-sm btn-danger ms-2">Hapus</button>
                                ...
                                <tr>
                                    ...
                                    <td class="align-middle">Kepala Tata Usaha</td>
                                    <td class="align-middle">
                                        <div class="d-flex justify-content-end">
                                            <button class="btn btn-sm btn-primary">Edit</button>
                                            <button class="btn btn-sm btn-danger ms-2">Hapus</button>
                                ...
                                <tr>
                                    ...
                                    <td class="align-middle">Staf Administrasi</td>
                                    <td class="align-middle">
                                        <div class="d-flex justify-content-end">
                                            <button class="btn btn-sm btn-primary">Edit</button>
                                            <button class="btn btn-sm btn-danger ms-2">Hapus</button>
